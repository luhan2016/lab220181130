...
if __name__ == '__main__':
    ...
    parser.add_argument('--servers', nargs='?', dest='nb_srv', default=7, type=int, help='The number of servers that should be running. If the number is even, the servers will be run in different regions. If the number is odd, all servers will be connected to the same switch.')
