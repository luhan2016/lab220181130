...
try:
    ...
    def propagate_to_vessels(path, payload = None, req = 'POST', leaderELected=False):
        global vessel_list, node_id, dead_nodeID
        for vessel_id, vessel_ip in vessel_list.items():
            if int(vessel_id) != node_id and int(vessel_id) != int(dead_nodeID): # don't propagate to yourself
    ...
    def main():
        ...
        global election_dict, countEM, countCM, leader_id, leader_rNum, countLeader, dead_nodeID
